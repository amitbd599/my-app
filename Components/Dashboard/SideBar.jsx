    ...
    <section id='side_bar' className='Admin'>
      <div className='sidebar_content'>
        ...
        <div className='menuItem'>
          <ul>
            <li className='active'>
              <a href='index.html' className='active d_flex'>
                <div className='svg'>
                  <svg
                    width={22}
                    height={22}
            ...
            <li>
              <a href='order.html' className='d_flex'>
                <div className='svg'>
                  <svg
                    width={20}
                    height={26}
            ...
            <li className='dropdown'>
              ...
              <ul className='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                ...
                <li>
                  <a className='dropdown-item' href='add_categort.html'>
                    Product Category
                  </a>
                </li>
              </ul>
            ...
            <li className='dropdown'>
              ...
              <ul className='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                <li>
                  <a className='dropdown-item' href='inventory.html'>
                    Inventory
                  </a>
                </li>
                <li>
                  <a className='dropdown-item' href='stock_in.html'>
                    Stock In
                  </a>
                </li>
                <li>
                  <a className='dropdown-item' href='product_return.html'>
                    Product Return
                  </a>
                </li>
              </ul>
            ...
            <li>
              <a href='support_ticket.html' className='d_flex'>
                <div className='svg'>
                  <svg
                    width={20}
                    height={20}
